...
const CreateAppModal = ({show, handleClose}: Props) => {
  ...
  const checkAppBasic = (): boolean => {
    if (!data.appBasic.projectName || !data.appBasic.description) {
      return false
    }
    return true
  }
            ...
            <div className='stepper-nav ps-lg-10'>
              ...
              <div className='stepper-item current' data-kt-stepper-element='nav'>
                ...
                <div className='stepper-wrapper'>
                  ...
                  <div className='stepper-label'>
                    ...
                    <div className='stepper-desc'>Project Details</div>
                  </div>
                  {/* end::Label*/}
                </div>
                {/* end::Wrapper*/}
              ...
              <div className='stepper-item' data-kt-stepper-element='nav'>
                ...
                <div className='stepper-wrapper'>
                  ...
                  {/* begin::Label*/}
                  <div className='stepper-label'>
                    <h3 className='stepper-title'>Surveyors</h3>

                    <div className='stepper-desc'>Select Surveyors</div>
                  </div>
                  {/* begin::Label*/}
                </div>
                {/* end::Wrapper*/}
              ...
              <div className='stepper-item' data-kt-stepper-element='nav'>
                ...
                <div className='stepper-wrapper'>
                  ...
                  {/* begin::Label*/}
                  <div className='stepper-label'>
                    <h3 className='stepper-title'>Tasks</h3>

                    <div className='stepper-desc'>Select Tasks</div>
                  </div>
                  {/* end::Label*/}
                </div>
                {/* end::Wrapper*/}
