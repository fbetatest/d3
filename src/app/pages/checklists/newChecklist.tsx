...
import {newChecklist} from './_requests'
...
const NewChecklist: FC = () => {
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>Create New Checklist</PageTitle>
            ...
            <div className='col-xxl-12'>
              <Formik
                ...
                onSubmit={(values) => {
                  ...
                  newChecklist(values.checklistName, values.projectName, values.surveyorName, values.questions).then(()=>{
