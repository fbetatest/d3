        ...
        <div className='card card-xxl-stretch mb-5 mb-xxl-8'>
          <div className='card-header border-0 pt-5'>
            ...
            <div className='card-toolbar'>
              {/* begin::Menu */}
              <Link to={'../new-project'} className='btn btn-sm fw-bold btn-primary'>
                Create New Project
              </Link>
                      ...
                      {projectsData.map((val, id) => {
                        return (
                          <tr key={id}>
                            ...
                            <td>
                              <span className='fs-7 fw-semibold'> {val.projectDescription}</span>
                            </td>
                            <td>
                              {' '}
                              {val.surveyors.map((v, id) => {
                                return (
                                  <span
                                    className='badge badge-light-success fs-7 fw-semibold me-2 mt-1'
                                    key={id}
                                  >
                                    {v}
                                  </span>
                            ...
                            <td>
                              ...
                              {val.tasks.map((v, id) => {
                                return (
                                  <span
                                    className='badge badge-light-warning fs-7 fw-semibold me-2 mt-1'
                                    key={id}
                                  >
                                    {v}
                                  </span>
